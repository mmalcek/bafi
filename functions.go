...
func templateFunctions() template.FuncMap {
	return template.FuncMap{
		...
		"trimAll":    func(a, b string) string { return strings.Trim(a, b) },
		"trimSuffix": func(a, b string) string { return strings.TrimSuffix(a, b) },
		"trimPrefix": func(a, b string) string { return strings.TrimPrefix(a, b) },
