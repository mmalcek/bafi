...
- Note: This is actually good place to use integrated [LUA interpreter](/#lua-custom-functions) where you can create your own set of custom functions to parse data and easily reuse them in templates.
